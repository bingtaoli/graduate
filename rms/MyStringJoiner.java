...
public final class MyStringJoiner {
     ...
     */
    public MyStringJoiner(CharSequence delimiter) {
        this(delimiter, "", "");
    }
     ...
     *         {@code null}
     */
    public MyStringJoiner setEmptyValue(CharSequence emptyValue) {
     ...
     */
    public MyStringJoiner add(CharSequence newElement) {
     ...
     */
    public MyStringJoiner merge(MyStringJoiner other) {
